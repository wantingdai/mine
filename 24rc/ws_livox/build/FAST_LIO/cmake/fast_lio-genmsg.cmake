...
set(MSG_I_FLAGS "-Ifast_lio:/home/ethan/ws_livox/src/FAST_LIO/msg;-Igeometry_msgs:/opt/ros/noetic/share/geometry_msgs/cmake/../msg;-Istd_msgs:/opt/ros/noetic/share/std_msgs/cmake/../msg")
...
get_filename_component(_filename "/home/ethan/ws_livox/src/FAST_LIO/msg/Pose6D.msg" NAME_WE)
add_custom_target(_fast_lio_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "fast_lio" "/home/ethan/ws_livox/src/FAST_LIO/msg/Pose6D.msg" ""
)
...
_generate_msg_cpp(fast_lio
  "/home/ethan/ws_livox/src/FAST_LIO/msg/Pose6D.msg"
  "${MSG_I_FLAGS}"
  ""
