...
from yolov5_utils import letterbox, scale_coords
...
class Detector():
    ...
    def __init__(self, opt):
        ...
        self.name = ['red_ball', 'purple_ball', 'blue_ball']
...
if __name__ == '__main__':
    ...
    parser.add_argument('--weights', nargs='+', type=str, default=r'D:\96537\Documents\Lab\2024_ROBOCON\vision\yolov5\mch_arm_add_pure\weights\mch_arm.onnx', help='onnx path(s)')
    parser.add_argument('--img', type=str, default=r'D:\96537\Documents\Lab\2024_ROBOCON\vision\yolov5\yolov5\data\images\red_ball.jpg', help='source')  # file/folder, 0 for webcam
